...
export const POST = async (request) => {
    ...
    try {
        ...
        const resetLink = `http://localhost:3000/creator/set-password?token=${token}`

        await transporter.sendMail({
            from: '"Reel Forest"',
            to: data.email,
            subject: "Create Password Request - Reel Forest",
            html: `
    <html>
            ...
            <table style="width: 100%; max-width: 600px; margin: auto; background-color: #ffffff; border: 1px solid #dddddd; border-radius: 8px; padding: 20px;">
                <tr>
                    <td style="text-align: center;">
                        ...
                        <p style="font-size: 16px; color: #555555; margin: 10px 0;">Verification Successful</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <p style="font-size: 14px; color: #555555; margin: 10px 0;">
                            Your email verification was successful! You can now create your password for your Reel Forest account. Click the button below to proceed:
                        </p>
                        <div style="text-align: center; margin: 20px 0;">
                            <a href=${resetLink} style="background-color: #28a745; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 4px; font-size: 16px;">Create Password</a>
                        </div>
                        <p style="font-size: 14px; color: #555555; margin: 10px 0;">
...
`,
        ...
        return NextResponse.json({ message: "Creator verified sucessfully", status: 1 });
    } catch (err) {
        console.log(err);
