                        ...
                        <div className='row'>
                            <div className='col-12 col-md-8'>
                                <div className='p-3'>
                                    ...
                                    <div className="mb-3 d-flex flex-column flex-sm-row" style={{ gap: "5px" }}>
                                        ...
                                        <button type="button" className={`btn btn-round ${categoryId == 1 ? "btn-info" : "btn-outline-info"}`}
                                            data-target=".bd-example-modal-lg" style={{ width: "110px" }} onClick={() => handleCategoryId(1)}>Premium </button>
                                        <button type="button" className={`btn btn-round ${categoryId == 2 ? "btn-info" : "btn-outline-info"}`}
                                            data-target=".bd-example-modal-sm" style={{ width: "110px" }} onClick={() => handleCategoryId(2)}>Micro </button>
                                        <button type="button" className={`btn btn-round ${categoryId == 3 ? "btn-info" : "btn-outline-info"}`}
                                            data-target="#exampleModal" style={{ width: "110px" }} onClick={() => handleCategoryId(3)}>Nano </button>
                                        <button type="button" className={`btn btn-round ${categoryId == 4 ? "btn-info" : "btn-outline-info"}`}
                                            data-target="#exampleModalCenter" style={{ width: "110px" }} onClick={() => handleCategoryId(4)}>Bulk </button>
                                        <button type="button" className={`btn btn-round ${categoryId == 5 ? "btn-info" : "btn-outline-info"}`}
                                            data-target="#exampleModalCenter" style={{ width: "110px" }} onClick={() => handleCategoryId(5)}>Page </button>
                                    </div>
...

                                    {
                                        categoryId == 3 && (
                                            <>
                                                <h6 className='my-2 mt-4'>Number of Creator</h6>
                                                <div className="input-group mb-3">
...

                                    {
                                        categoryId == 4 && (
                                            <>
                                                <h6 className='my-2 mt-4'>Number of Creator</h6>
                                                <div className="input-group mb-3">
                                                    <input type="number" min={1000} className="form-control" placeholder="number of creator" defaultValue={1000} />
                                                </div>
                                            </>
                                        )
                                    }
