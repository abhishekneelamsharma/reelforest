...
const page = () => {
    ...
    const [totalCreator, setTotalCreators] = useState(0);
    ...
    const addtoKart = async () => {
        try {
            ...
            if (activeCategory == 1 || activeCategory == 2 || activeCategory == 2) {
    ...
    const getTotalData = () => {
        ...
        setTotalCreators(total_no_of_creator)
    }
    ...
    const finalSubmit = async () => {
        ...
        const res = await axios.post("/api/order/place_order", {
            ...
            total_no_of_creators: totalCreator,
                        ...
                        <div className='row'>
                                        ...
                                        activeCategory == 3 && (
                                            <>
                                                <motion.div
                                                    ...
                                                    <div className="input-group mb-3">
                                                        <input type="number" min={100} className="form-control" placeholder="number of creator" defaultValue={selectedNumberOfCretor} onChange={(e) => setSelectedNumberOfCretor(e.target.value)} />
                                                    </div>
                                        ...
                                        activeCategory == 4 && (
                                            <>
                                                <motion.div
                                                    ...
                                                    <div className="input-group mb-3">
                                                        <input type="number" min={1000} className="form-control" placeholder="number of creator" defaultValue={selectedNumberOfCretor} onChange={(e) => setSelectedNumberOfCretor(e.target.value)} />
                                                    </div>
...

                            {
                                ...
                                <div className="col-12 col-lg-4 mt-5">
                                    ...
                                    <div className="input-group mb-3">
                                        <input type="text" className="form-control" placeholder="total number of creators" defaultValue={totalCreator} />
                                    </div>
                                    <h6 className='my-2 mt-4'>Total amount</h6>
                                    <div className="input-group mb-3">
                                        <input type="text" className="form-control" placeholder="total amount" defaultValue={totalAmount} />
                                    </div>
