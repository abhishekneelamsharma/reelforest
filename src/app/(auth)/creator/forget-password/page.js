...
const page = () => {
    ...
    const onsubmitEmail = async (data) => {
        try {
            const res = await axios.post("/api/creator/forget-password", {
                email: data.email
            })
                            ...
                            <div className="body">
                                ...
                                <form className="form-auth-small">
                                    ...
                                    <div className="bottom">
                                        <span className="helper-text">Know your password? <Link href="
                                        /creator/login">Login</Link></span>
                                    </div>
                                </form>
                            </div> :
                            <div className="body">
                                ...
                                <form className="form-auth-small">
                                    ...
                                    <div className="bottom">
                                        <span className="helper-text">Know your password? <Link href="/creator/login">Login</Link></span>
                                    </div>
                                </form>
                            </div>
                    }
